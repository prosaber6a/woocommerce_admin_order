...
function woo_sku_order_shortcode () {


    if (!is_integer(is_user_logged_in()) && !current_user_can('manage_woocommerce')) return;

    woo_admin_order_assets('toplevel_page_woo-admin-order');
    ?>
...
add_shortcode('woo_sku_order', 'woo_sku_order_shortcode');